...
import com.cleitonmelo.cursomc.domain.Pagamento;
import com.cleitonmelo.cursomc.domain.PagamentoComBoleto;
import com.cleitonmelo.cursomc.domain.PagamentoComCartao;
...
import com.cleitonmelo.cursomc.repositories.EstadoRepository;
...
import com.cleitonmelo.cursomc.repositories.ProdutoRepository;
...
public class DBservice {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria(null, "Brinquedos e Bebê");
		Categoria cat5 = new Categoria(null, "Automotico");
		Categoria cat6 = new Categoria(null, "Games, livros e filmes");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "cleitonmelo@hotmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("12345678"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Cleiton Melo", "cleitonmelo@gmail.com", "52256752470",
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("12345678"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("912355444", "14253622"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "84000222", cli2, c2);
